...
final class Store: ObservableObject {
    ...
    /// Free tier allows this many total dose entries before the paywall appears.
    ...
    init() {
        ...
        entriesURL = support.appendingPathComponent("pillcheck_entries.json")
        settingsURL = support.appendingPathComponent("pillcheck_settings.json")
        load()
        if entries.isEmpty {
            seed()
        }
